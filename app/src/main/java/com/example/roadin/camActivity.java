...
public class camActivity extends AppCompatActivity implements LocationListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btnStorage=(Button) findViewById(R.id.storageBtn) ;
    ...
    */
        ...
        switch (requestCode) {
            case 1: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(camActivity.this, "Permission denied to read your External storage", Toast.LENGTH_SHORT).show();
                }
                return;
            }
    ...
    public void showSettingsAlert(){
        ...
        //alertDialog.show();
        Toast.makeText(camActivity.this, "Turn gps on", Toast.LENGTH_SHORT).show();
    }
    ...
    private void uploadImage() {
        ...
        if(fileUri != null)
        {
            ...
            StorageMetadata metadata = new StorageMetadata.Builder()
                    ...
                    .setCustomMetadata(Double.toString(latitude),Double.toString(longitude))
                    .build();

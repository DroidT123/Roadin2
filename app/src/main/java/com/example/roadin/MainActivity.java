...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx.replace(R.id.mainLayout,startFragment);
        tx.commit();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.map1) {
            ...
            fragmentManager.beginTransaction().replace(R.id.mainLayout,mFragment).commit();
    ...
    public void start(View view) {
        ...
        fmg.beginTransaction().replace(R.id.mainLayout,mFragment).commit();
